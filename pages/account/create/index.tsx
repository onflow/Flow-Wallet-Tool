...
import { HASH_ALGO, SIGN_ALGO } from "@/lib/constants";
...
function CreateAccountForm() {
  ...
  const [mode, setMode] = useState("pubkey");
              ...
              toast({
                ...
                action: (
                  <ToastAction
                    ...
                    onClick={() =>
                      window.open(
                        `https://www.flowdiver.io/account/${address}`,
                        "_blank"
                      )
                    }
                  >
        ...
        toast({
          ...
          action: (
            <ToastAction
              altText="FlowDiver"
              onClick={() =>
                window.open(`https://www.flowdiver.io/tx/${txId}`, "_blank")
              }
            >
              View on FlowDiver
            </ToastAction>
        ...
        <div className="flex flex-col items-center gap-4">
          <Button
            ...
            disabled={
              loading ||
              sealing ||
              (mode === "pubkey" ? !publicKey : !seedPhrase)
            }
          >
            {(loading || sealing) && (
              ...
              <div className="flex flex-col gap-2 w-full">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `https://www.flowdiver.io/tx/${txId}`,
                        "_blank"
                      )
                    }
                  >
                ...
                <div className="flex flex-col gap-2 w-full">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://www.flowdiver.io/account/${flowAddress}`,
                          "_blank"
                        )
                      }
                    >
